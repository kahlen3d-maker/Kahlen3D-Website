...
const dictionaries = {
  de: {
    ...
    shop: {
      badge: "Shop",
      title: "Shop",
      subtitle: "Gedruckte Produkte und STL-Dateien direkt bestellen.",
      typePhysical: "Druck",
      typeDigital: "STL-Datei",
      ...
      remove: "Entfernen",
      empty: "Leeren",
      taxNote: "Kleinunternehmer gemäß § 19 UStG – keine Umsatzsteuer ausgewiesen.",
      shippingNote: "Versandkosten für gedruckte Produkte werden an der Kasse berechnet.",
      checkoutError: "Die Kasse konnte nicht geöffnet werden. Bitte versuche es später erneut.",
      notConfigured: "Der Shop-Bezahlvorgang ist noch nicht freigeschaltet.",
      opening: "Kasse wird geöffnet …",
      successTitle: "Vielen Dank für deinen Einkauf!",
      successText: "Deine Bestellung ist eingegangen. Bei digitalen Dateien erhältst du die Download-Links per E-Mail.",
    ...
    contact: {
      ...
      attachments: "Anhänge",
      attachmentsHint: "Bilder, PDF oder 3D-Dateien (STL, STEP, 3MF …) · optional · max. 50 MB pro Datei",
      attachmentsButton: "Dateien auswählen",
      attachmentsTooLarge: "Eine Datei ist zu groß (max. 50 MB pro Datei).",
      attachmentsType: "Nur Bilder, PDF und 3D-Dateien (STL, STEP …) sind erlaubt.",
  ...
  en: {
    ...
    shop: {
      badge: "Shop",
      title: "Shop",
      subtitle: "Order printed products and STL files directly.",
      typePhysical: "Print",
      typeDigital: "STL file",
      ...
      remove: "Remove",
      empty: "Clear",
      taxNote: "Small business under § 19 UStG – no VAT shown.",
      shippingNote: "Shipping for printed products is calculated at checkout.",
      checkoutError: "Checkout could not be opened. Please try again later.",
      notConfigured: "Shop checkout is not activated yet.",
      opening: "Opening checkout …",
      successTitle: "Thank you for your purchase!",
      successText: "Your order has been received. For digital files you will receive the download links by email.",
    ...
    contact: {
      ...
      attachmentsHint: "Images, PDF or 3D files (STL, STEP, 3MF …) · optional · max. 50 MB per file",
      attachmentsButton: "Choose files",
      attachmentsTooLarge: "A file is too large (max. 50 MB per file).",
      attachmentsType: "Only images, PDF and 3D files (STL, STEP …) are allowed.",
